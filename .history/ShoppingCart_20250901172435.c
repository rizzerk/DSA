...
{ 
  ...
  //   printf("%s", PL.prodList[i].prodID);
	// printf("%s", PL.prodList[i].prodName);
	// printf("%.2f", PL.prodList[i].unitPrice);
	// printf("%-10s", PL.prodList[i].qty);
  printf("\n%-10s%-15s%-10.2f%-10d%-15.2f", PL.prodList[i].prodID, PL.prodList[i].prodName, PL.prodList[i].unitPrice, PL.prodList[i].qty);
